defmodule AliancerWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-4 sm:p-10 lg:p-14 shadow-lg ring-1 transition"
            >
  ...
  attr :control_class, :string, default: ""
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AliancerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AliancerWeb.Gettext, "errors", msg, opts)
    end
  end
